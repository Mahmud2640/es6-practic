...
const roll = 50;
// console.log(id, roll);
const student1 = {studentName: 'Abdul Karim', roll: 10, address: 'Dhaka', FatherName: 'Abdur Rahim' }

// ২. টেম্পলেট স্ট্রিং দিয়ে একটা স্ট্রিং তৈরি করো। সেটার মধ্যে উপরে ডিক্লেয়ার করা ভেরিয়েবল এর মান ডাইনামিক ভাবে বসাও। একইভাবে উপরে একটা অবজেক্ট ডিক্লেয়ার করো। এবং ডাইনামিকভাবে উপরের অবজেক্ট এর দুইটা প্রপার্টি এর মান তোমার টেমপ্লেট স্ট্রিং এর মধ্যে বসাও। 

const studentInfo = ` this is her student id :- ${id} and this is her roll number :- ${roll}.\n what is your name ? what is your father name !!!! `;
const information = `this is student full infomation with name ${student1.studentName}, her roll ${student1.roll}, her addresh ${student1.address}. this is final nd i dont want to know about more.`;
...
const total = value(50, 50);
// console.log(total);

// ৩.৩ এইবার তিনটা প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন ডিক্লেয়ার করো। যেই ফাংশনের কাজ হবে তিনটা প্যারামিটার নিয়ে সেই তিনটা প্যারামিটারকে গুণ করে সেই রেজাল্ট রিটার্ন করবে। 

const diff = (num1, num2, num3) => num1 * num2 * num3;

const final = diff(10, 10, 10);
console.log(final);
